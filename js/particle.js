...
Particle.prototype.init = function (i) {
    ...
    particle.targetPosition = new THREE.Vector3((textPixels[i].x - (width / 2)) * 3.5, (textPixels[i].y + (height / 9)) * 3, -10 * Math.random() + 20);
...
function updateText() {
    ...
    var pix = textCtx.getImageData(0, 0, width*2, 300).data;
    textPixels = [];
